...
path('employe/<pk>/liste/', views.employe_list, name='employe_list_filtre'),
...
path('employe/<pk>/traiter-demande_filtre', views.trait_demande_conge,name='trait_demande_conge_filtre'),
